  ...
  function Home({ theme }) {
    ...
    return (
      <motion.div
        ...
        className="lg:min-h-[85vh] flex flex-col lg:flex-row relative overflow-hidden z-0 lg:px-36 lg:py-0 lg:mt-[-2rem] mt-[-3rem] px-8 py-8"
      >
        <motion.div
        ...
        <motion.div
          className="fixed right-6 top-[57%] lg:transform lg:-translate-y-1/2"
